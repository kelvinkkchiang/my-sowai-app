...
AML/KYC Source of Wealth platform for private bankers to run name screening, adverse media checks, and generate compliant SOW reports with a paid subscription gate.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "279755374+kelvinkkchiang@users.noreply.github.com"
  git config user.name "kelvinkkchiang"
  ```
